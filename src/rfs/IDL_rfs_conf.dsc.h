...
_WINDLL_FUNC int DSCSERIALIZE_JSON_rfs_conf( rfs_conf *pst , char *encoding , char *buf , int *p_len );
_WINDLL_FUNC int DSCSERIALIZE_JSON_DUP_rfs_conf( rfs_conf *pst , char *encoding , char **pp_base , int *p_buf_size , int *p_len );
_WINDLL_FUNC int DSCSERIALIZE_JSON_DUP_rfs_conf_V( void *pv , char *encoding , char **pp_base , int *p_buf_size , int *p_len );
_WINDLL_FUNC int DSCDESERIALIZE_JSON_rfs_conf( char *encoding , char *buf , int *p_len , rfs_conf *pst );
_WINDLL_FUNC int DSCDESERIALIZE_JSON_rfs_conf_V( char *encoding , char *buf , int *p_len , void *pv );
