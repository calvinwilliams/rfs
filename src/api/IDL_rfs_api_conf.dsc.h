...
#ifndef _H_rfs_api_conf_
#define _H_rfs_api_conf_
...
_WINDLL_FUNC int DSCSERIALIZE_JSON_rfs_api_conf( rfs_api_conf *pst , char *encoding , char *buf , int *p_len );
_WINDLL_FUNC int DSCSERIALIZE_JSON_DUP_rfs_api_conf( rfs_api_conf *pst , char *encoding , char **pp_base , int *p_buf_size , int *p_len );
_WINDLL_FUNC int DSCSERIALIZE_JSON_DUP_rfs_api_conf_V( void *pv , char *encoding , char **pp_base , int *p_buf_size , int *p_len );
_WINDLL_FUNC int DSCDESERIALIZE_JSON_rfs_api_conf( char *encoding , char *buf , int *p_len , rfs_api_conf *pst );
_WINDLL_FUNC int DSCDESERIALIZE_JSON_rfs_api_conf_V( char *encoding , char *buf , int *p_len , void *pv );
